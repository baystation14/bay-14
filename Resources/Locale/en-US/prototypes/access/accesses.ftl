...
id-card-access-level-head-of-personnel = Executive Officer
id-card-access-level-cryogenics = Cryogenics
id-card-access-level-emergency-shuttle-repeal = E.Shuttle Repeal All

id-card-access-level-head-of-security = Chief of Security
...
id-card-access-level-research-director = Chief Science Officer
...
id-card-access-level-quartermaster = Deck Chief
id-card-access-level-cargo = Deck Technician
id-card-access-level-salvage = Prospector
